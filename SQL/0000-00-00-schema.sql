...
CREATE TABLE `candidate` (
  ...
  CONSTRAINT `FK_candidate_1` FOREIGN KEY (`CenterID`)
...
CREATE TABLE `examiners` (
  ...
  CONSTRAINT `FK_examiners_1` FOREIGN KEY (`centerID`)
    REFERENCES `psc` (`CenterID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `feedback_bvl_entry` (
  ...
  CONSTRAINT `FK_feedback_bvl_entry_1` FOREIGN KEY (`FeedbackID`)
...
CREATE TABLE `feedback_bvl_thread` (
  ...
  CONSTRAINT `FK_feedback_bvl_thread_1` FOREIGN KEY (`Feedback_type`)
...
CREATE TABLE `feedback_mri_predefined_comments` (
  ...
  CONSTRAINT `FK_feedback_mri_predefined_comments_1` FOREIGN KEY (`CommentTypeID`)
...
CREATE TABLE `feedback_mri_comments` (
  ...
  CONSTRAINT `FK_feedback_mri_comments_4` FOREIGN KEY (`SessionID`)
    REFERENCES `session` (`ID`),
  CONSTRAINT `FK_feedback_mri_comments_1` FOREIGN KEY (`CommentTypeID`)
    REFERENCES `feedback_mri_comment_types` (`CommentTypeID`),
  CONSTRAINT `FK_feedback_mri_comments_2` FOREIGN KEY (`PredefinedCommentID`)
    REFERENCES `feedback_mri_predefined_comments` (`PredefinedCommentID`),
  CONSTRAINT `FK_feedback_mri_comments_3` FOREIGN KEY (`FileID`)
...
CREATE TABLE `mri_processing_protocol` (
  ...
  CONSTRAINT `FK_mri_processing_protocol_FileTypes` FOREIGN KEY (`FileType`)
...
CREATE TABLE `mri_scanner` (
  ...
  CONSTRAINT `FK_mri_scanner_1` FOREIGN KEY (`CandID`)
...
CREATE TABLE `files` (
  ...
  CONSTRAINT `FK_files_2` FOREIGN KEY (`AcquisitionProtocolID`)
    REFERENCES `mri_scan_type` (`ID`),
  CONSTRAINT `FK_files_1` FOREIGN KEY (`SessionID`)
    REFERENCES `session` (`ID`),
  CONSTRAINT `FK_files_3` FOREIGN KEY (`SourceFileID`)
    REFERENCES `files` (`FileID`),
  CONSTRAINT `FK_files_4` FOREIGN KEY (`ProcessProtocolID`)
    REFERENCES `mri_processing_protocol` (`ProcessProtocolID`),
  CONSTRAINT `FK_files_FileTypes` FOREIGN KEY (`FileType`)
    REFERENCES `ImagingFileTypes` (`type`),
  CONSTRAINT `FK_files_scannerID` FOREIGN KEY (`ScannerID`)
...
CREATE TABLE `flag` (
  ...
  CONSTRAINT `FK_flag_1` FOREIGN KEY (`SessionID`)
    REFERENCES `session` (`ID`)
    ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `FK_flag_2` FOREIGN KEY (`Test_name`)
...
CREATE TABLE `instrument_subtests` (
  ...
  CONSTRAINT `FK_instrument_subtests_1` FOREIGN KEY (`Test_name`)
    REFERENCES `test_names` (`Test_name`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `mri_acquisition_dates` (
  ...
  CONSTRAINT `FK_mri_acquisition_dates_1` FOREIGN KEY (`SessionID`)
    REFERENCES `session` (`ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `mri_protocol` (
  ...
  CONSTRAINT `FK_mri_protocol_1` FOREIGN KEY (`ScannerID`)
    REFERENCES `mri_scanner` (`ID`)
...
CREATE TABLE `notification_spool` (
  ...
  CONSTRAINT `FK_notification_spool_2` FOREIGN KEY (`CenterID`)
    REFERENCES `psc` (`CenterID`),
  CONSTRAINT `FK_notification_spool_1` FOREIGN KEY (`NotificationTypeID`)
...
CREATE TABLE `parameter_candidate` (
  ...
  CONSTRAINT `FK_parameter_candidate_2` FOREIGN KEY (`CandID`)
    REFERENCES `candidate` (`CandID`),
  CONSTRAINT `FK_parameter_candidate_1` FOREIGN KEY (`ParameterTypeID`)
...
CREATE TABLE `parameter_file` (
  ...
  KEY `parameter_value` (`ParameterTypeID` , `Value` (64)),
  CONSTRAINT `FK_parameter_file_2` FOREIGN KEY (`ParameterTypeID`)
    REFERENCES `parameter_type` (`ParameterTypeID`),
  CONSTRAINT `FK_parameter_file_1` FOREIGN KEY (`FileID`)
    REFERENCES `files` (`FileID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `parameter_session` (
  ...
  KEY `parameter_value` (`ParameterTypeID` , `Value` (64)),
  CONSTRAINT `FK_parameter_session_2` FOREIGN KEY (`ParameterTypeID`)
    REFERENCES `parameter_type` (`ParameterTypeID`),
  CONSTRAINT `FK_parameter_session_1` FOREIGN KEY (`SessionID`)
    REFERENCES `session` (`ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `parameter_type_category_rel` (
  ...
  CONSTRAINT `FK_parameter_type_category_rel_2` FOREIGN KEY (`ParameterTypeCategoryID`)
    REFERENCES `parameter_type_category` (`ParameterTypeCategoryID`),
  CONSTRAINT `FK_parameter_type_category_rel_1` FOREIGN KEY (`ParameterTypeID`)
    REFERENCES `parameter_type` (`ParameterTypeID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `session` (
  ...
  CONSTRAINT `FK_session_2` FOREIGN KEY (`CenterID`)
    REFERENCES `psc` (`CenterID`),
  CONSTRAINT `FK_session_1` FOREIGN KEY (`CandID`)
    REFERENCES `candidate` (`CandID`)
...
CREATE TABLE `tarchive_series` (
  ...
  CONSTRAINT `tarchive_series_ibfk_1` FOREIGN KEY (`TarchiveID`)
...
CREATE TABLE `tarchive_files` (
  ...
  CONSTRAINT `tarchive_files_ibfk_1` FOREIGN KEY (`TarchiveID`)
    REFERENCES `tarchive` (`TarchiveID`)
    ON DELETE CASCADE,
  CONSTRAINT `tarchive_files_TarchiveSeriesID_fk` FOREIGN KEY (`TarchiveSeriesID`)
    REFERENCES `tarchive_series` (`TarchiveSeriesID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `test_battery` (
  ...
  CONSTRAINT `FK_test_battery_1` FOREIGN KEY (`Test_name`)
    REFERENCES `test_names` (`Test_name`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `test_names` (
  ...
  CONSTRAINT `FK_test_names_1` FOREIGN KEY (`Sub_group`)
...
CREATE TABLE `users` (
  ...
  CONSTRAINT `FK_users_1` FOREIGN KEY (`CenterID`)
    REFERENCES `psc` (`CenterID`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8;
...
CREATE TABLE `certification` (
  ...
  CONSTRAINT `FK_certifcation` FOREIGN KEY (`testID`)
...
CREATE TABLE `files_intermediary` (
  ...
  CONSTRAINT `FK_files_intermediary_1` FOREIGN KEY (`Output_FileID`)
    REFERENCES `files` (`FileID`),
  CONSTRAINT `FK_files_intermediary_2` FOREIGN KEY (`Input_FileID`)
    REFERENCES `files` (`FileID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `SNP` (
  ...
  `GenomeLocID` bigint(20) DEFAULT NULL,
  PRIMARY KEY (`SNPID`),
  CONSTRAINT `SNP_ibfk_2` FOREIGN KEY (`GenomeLocID`)
...
CREATE TABLE `genomic_files` (
  ...
  CONSTRAINT `genomic_files_ibfk_1` FOREIGN KEY (`AnalysisModality`)
    REFERENCES `genomic_analysis_modality_enum` (`analysis_modality`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `certification_training` (
  ...
  PRIMARY KEY (`ID`),
  CONSTRAINT `FK_certification_training` FOREIGN KEY (`TestID`)
    REFERENCES `test_names` (`ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `certification_training_quiz_questions` (
  ...
  `OrderNumber` INTEGER UNSIGNED NOT NULL,
  PRIMARY KEY (`ID`),
  CONSTRAINT `FK_certification_training_quiz_questions` FOREIGN KEY (`TestID`)
    REFERENCES `test_names` (`ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `certification_training_quiz_answers` (
  ...
  `OrderNumber` INTEGER UNSIGNED NOT NULL,
  PRIMARY KEY (`ID`),
  CONSTRAINT `FK_certification_training_quiz_answers` FOREIGN KEY (`QuestionID`)
    REFERENCES `certification_training_quiz_questions` (`ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `server_processes` (
  ...
  CONSTRAINT `FK_task_1` FOREIGN KEY (`userid`)
...
CREATE TABLE `ExternalLinks` (
  ...
  FOREIGN KEY (LinkTypeID)
    REFERENCES ExternalLinkTypes (LinkTypeID)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `data_release_permissions` (
  ...
  CONSTRAINT `FK_userid` FOREIGN KEY (`userid`)
    REFERENCES `users` (`ID`),
  CONSTRAINT `FK_data_release_id` FOREIGN KEY (`data_release_id`)
    REFERENCES `data_release` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
/*!40014 SET @OLD_FOREIGN_KEY_CHECKS=@@FOREIGN_KEY_CHECKS, FOREIGN_KEY_CHECKS=0 */;
  ...
  --
  -- Dumping data for table `ImagingFileTypes`
  --
