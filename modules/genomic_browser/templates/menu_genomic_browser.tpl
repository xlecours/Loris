  ...
  <div class="row">
    <div id="tabs"> 
      <ul class="nav nav-tabs">
        <li class="statsTab active"><a class="statsTabLink" id="onLoad"><strong>Profile</strong></a></li>
        ...
        <!-- print out data rows -->
          {section name=piece loop=$items[item]}
            ...
            {elseif $items[item][piece].name eq "SNPs" }
                 <a href="main.php?test_name=genomic_browser&submenu=snp_browser&PSCID={$PSCID}" class="snp_link" data-pscid="{$PSCID}" >{$items[item][piece].value}</a>
            {elseif $items[item][piece].name eq "CNVs" }
                 <a href="main.php?test_name=genomic_browser&submenu=cnv_browser&PSCID={$PSCID}" class="cnv_link" data-pscid="{$PSCID}" >{$items[item][piece].value}</a>
            {elseif $items[item][piece].name eq "CpGs" }
                 <a href="main.php?test_name=genomic_browser&submenu=cpg_browser&PSCID={$PSCID}" class="cpg_link" data-pscid="{$PSCID}" >{$items[item][piece].value}</a>
            {else}
