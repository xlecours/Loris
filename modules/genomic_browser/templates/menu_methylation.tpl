  ...
  <div class="row">
    <div class="tab-content">
      <div class="tab-pane active">
        <form method="post" action="{$baseurl}/genomic_browser/?submenu=methylation">
          <div class="col-sm-12">
            <div class="row">
                  ...
                  <div class="panel-body" id="panel-body-gene">
                    ...
                    <div class="row">
                      <div class="form-group col-sm-12">
                        ...
                        <div class="col-sm-12 col-md-2"></div>
                        <label class="col-sm-12 col-md-2" data-toggle="tooltip" data-placement="top" title="ex: chr14:68341139-69341267">
                ...
                <div class="row">
                  <div class="form-group col-sm-12">
                    ...
                    <div class="col-sm-6 col-xs-12 col-md-5">
                      <input type="button" name="reset" value="Clear Form" class="btn btn-sm btn-primary col-xs-12" onclick="location.href='{$baseurl}/genomic_browser/?submenu=methylation&reset=true'" />
                    </div>
                  </div>
                </div>
              </div>
...
var table = RDynamicDataTable({
    "DataURL" : "{$baseurl}/genomic_browser/?submenu=methylation&format=json",
