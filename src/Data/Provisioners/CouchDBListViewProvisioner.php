 ...
 * @link       https://www.github.com/aces/Loris/
 */
abstract class CouchDBListViewProvisioner extends \LORIS\Data\ProvisionerInstance
{
    private $_couchdb;
    private $_config;
    private $_designdoc;
     ...
     *
     */
    public function __construct(string $designdoc, string $list, string $view, array $params)
    {
    ...
    public function withParams(array $params): CouchDBListViewProvisioner
    {
        $new = clone($this);
        $new->_params = $params;
        return $new;
    ...
    public function withAddedFilter($filter): CouchDBListViewProvisioner
    {
    ...
    public function withMapper($mapper): CouchDBListViewProvisioner
    {
    ...
    protected function sendQuery(): \SocketWrapper
    {
        ...
        $url   = "_design/" . $this->_designdoc . "/_list/" . $this->_list . '/' . $this->_view
